	...
	<main class="mdl-layout__content mdl-color--grey-100">
		...
		<div class="mdl-card mdl-shadow--2dp employer-form" action="#">
	        <div class="mdl-card__supporting-text">
	            <form:form action="${s:mvcUrl('EC#pesquisarEvento').build()}" method="POST" cssClass="form">
                    <div class="mdl-grid">
		...
		<div class="mdl-cell mdl-cell--12-col-desktop mdl-cell--12-col-tablet mdl-cell--4-col-phone ">
			<table class="mdl-data-table mdl-js-data-table mdl-data-table--selectable mdl-shadow--2dp projects-table">
				...
				<c:forEach items="${Eventos}" var="Evento">
					<tr>
						<td class="mdl-data-table__cell--non-numeric">${Evento.nome}</td>
						<td class="mdl-data-table__cell--non-numeric">${Evento.capitao}</td>
						<td class="mdl-data-table__cell--non-numeric">
							<a href="${s:mvcUrl('EC#editarEvento').arg(0, Evento.id).build()}" title="Editar">
								<i class="material-icons">mode_edit</i>
							</a>
							<a href="${s:mvcUrl('EC#excluirEvento').arg(0, Evento.id).build()}" title="Excluir">
			...
			<div class="mdl-card__rodape">
	                <div>
		                <a class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--colored-light-blue" 
		                	...
		                	href="${s:mvcUrl('EC#exibirNumeros').build()}" 
