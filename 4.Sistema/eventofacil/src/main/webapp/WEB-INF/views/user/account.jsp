            ...
            <div class="mdl-card__supporting-text">
                <form action="#" class="form">
                    ...
                    <div class="form__article">
                        ...
                        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="partition-fullevento">
                            <input type="radio" id="partition-fullevento" class="mdl-radio__button" name="employment" value="1" checked/>
                            <span class="mdl-radio__label">Fullevento</span>
                        </label>
                        <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect" for="partition-partEvento">
                            <input type="radio" id="partition-partEvento" class="mdl-radio__button" name="employment" value="2"/>
                            <span class="mdl-radio__label">Part evento</span>
                        </label>
